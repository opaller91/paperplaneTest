...
import profile from '../../assets/images/logos/logo-black.png'
...
const InstaPost = ({ img }) => {
    ...
    return (
        ...
        <div className="bg-white border rounded-sm max-w-md">
            ...
            <div className="ml-3 ">
                <span className="text-sm font-semibold antialiased block leading-tight">paperplaneproject.studio</span>
                <span className="text-gray-600 text-xs block">Bangkok, Thailand</span>
            </div>
            </div>
            <img alt='Post' src={img.picture}/>
            <div className="flex items-center justify-between mx-3 mt-2 mb-2">
            ...
            <div className="flex flex-col font-semibold text-sm mx-3 mb-2">
                <div>{ img.likes } likes</div>
                <div>paperplaneproject.studio 
                    <span className='ml-1 font-normal break-words'>{ img.caption }</span>
                </div>
            </div>
        </div>
        </div>
