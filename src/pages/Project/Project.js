...
import './Project.css'; // Create and import a CSS file for styles
...
class Work extends Component {
  ...
  render() {
    ...
    return (
      <section id="projects">
        <div className="flex justify-center mb-2 font-bold text-black text-4xl font-montserrat">
        ...
        <div className="flex justify-center">
          <p className="mb-16 flex font-medium text-black text-xl font-montserrat space-x-6">
            <a
              href="#"
              onClick={() => this.handleFilterClick('ALL PROJECTS')}
              className={`font-semibold text-black font-montserrat no-underline hover:underline ${activeFilter === 'ALL PROJECTS' ? 'text-blue-500' : ''
                }`}
            >
              All
            </a>
            ...
            <a
              href="#"
              onClick={() => this.handleFilterClick('COCKTAIL BAR')}
              className={`font-semibold text-black font-montserrat no-underline hover:underline ${activeFilter === 'COCKTAIL BAR' ? 'text-blue-500' : ''
                }`}
            >
              Cocktail Bar
            </a>
            ...
            <a
              href="#"
              onClick={() => this.handleFilterClick('RESTAURANT')}
              className={`font-semibold text-black font-montserrat no-underline hover:underline ${activeFilter === 'RESTAURANT' ? 'text-blue-500' : ''
                }`}
            >
              Restaurant
            </a>
                  ...
                  <div className="absolute inset-0 hidden bg-black bg-opacity-50 group-hover:flex">
                    <div className="my-12 mx-7 text-left text-white font-montserrat transform transition duration-300 translate-x-full group-hover:translate-x-0">
                      ...
                      <span
                        ...
                        style={{
                          transformOrigin: this.state.hovered ? 'left' : 'right',
                        }}
                      ></span>
